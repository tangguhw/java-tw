...
//merupakan kelas anak Anjing yang berasal dari super class Binatang
//objek class bernama Anjing yang dapat diakses oleh class lain.
//extends pada java berfungsi untuk memanggil fungsi dari class lain, disini objek memanggil fungsi dari kelas Binatang
    ...
    public Anjing(String nama) {//konstruktor
        super("Anjing ");
        this.nama = nama;
